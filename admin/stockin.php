      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            ?>
            <form class="form-horizontal" action="php/stockin.php" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="stockin" class="col-sm-2 control-label">Quantity (to be added)</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="stockin" name="stockin" placeholder="Quantity">
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
